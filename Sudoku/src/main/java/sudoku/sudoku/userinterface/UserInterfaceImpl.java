package sudoku.sudoku.userinterface;
...
public class UserInterfaceImpl implements  IUserInterfaceContract.View,
        ...
        //private SudokuTextField one, two, three, four,five...
    ...
    private void drawTextFields(Group root) {
        ...
        final int xAndYDelta = 64; //change in x and y value
    ...
    private void styleSudokuTitle(SudokuTextField tile, int x, int y) {
